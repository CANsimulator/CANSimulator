        ...
        if (this.state.hasError) {
            ...
            return (
                ...
                >
                    ...
                    <p className="text-gray-400 font-mono text-[10px] mb-6 max-w-sm uppercase tracking-tight opacity-80">
                    ...
                    <div className="flex gap-3">
                        {!maxRetriesReached && (
                            <button
                                ...
                                className="px-4 py-2 text-[10px] font-mono font-bold uppercase tracking-widest bg-cyber-blue/10 border border-cyber-blue/40 text-cyber-blue rounded-lg hover:bg-cyber-blue/20 transition-all active:scale-95 shadow-[0_0_15px_rgba(0,243,255,0.1)]"
                            >
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-[10px] font-mono font-bold uppercase tracking-widest bg-white/5 border border-white/10 text-gray-300 rounded-lg hover:bg-white/10 transition-all active:scale-95"
                        >
                            Reload Page
                        </button>
                    </div>
                    ...
                    <div className="mt-8 pt-4 border-t border-white/5 w-full max-w-xs">
                        <p className="text-[8px] font-mono text-gray-500 uppercase">
                            Error Ref: {Math.random().toString(36).substring(7).toUpperCase()} | Stack: Subsystem Failure
                        </p>
                    </div>
                </div>
            );
