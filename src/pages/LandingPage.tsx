    ...
    const features = [
        {
            ...
            accent: isDark ? 'cyber-purple' : 'purple-600'
        },
        {
            icon: Activity,
            ...
            accent: isDark ? 'cyber-blue' : 'blue-600'
        },
        {
            icon: TestTube,
            ...
            accent: isDark ? 'cyber-green' : 'green-700'
        },
        {
            icon: Network,
            ...
            accent: isDark ? 'cyber-pink' : 'rose-600'
        },
        {
            icon: GraduationCap,
            ...
            accent: isDark ? 'yellow-400' : 'amber-600'
        },
        {
            icon: Zap,
            ...
            accent: isDark ? 'indigo-400' : 'indigo-600'
        }
    ];
                ...
                <div id="landing-hero-container">
                    ...
                    <div className="container mx-auto px-4 pt-24 pb-16 sm:pt-32 sm:pb-24 lg:pt-40 lg:pb-32">
                        <div className="text-center max-w-7xl mx-auto">
                            ...
                            >
                                <span className="text-blue-600 dark:text-cyber-blue text-sm font-semibold flex items-center gap-2">
                                    <Sparkles size={14} className="text-blue-600 dark:text-cyber-blue" />
                            ...
                            <motion.p
                                ...
                                className="text-2xl sm:text-3xl text-light-600 dark:text-gray-400 mb-12 max-w-4xl mx-auto font-black leading-tight tracking-tight italic"
                            >
                                Why invest in expensive hardware interfaces? Simulate complex{' '}
                                <span className="text-blue-600 dark:text-cyber-blue">CAN and CAN FD</span> networks instantly in your browser. Engineering-grade fidelity at $0 cost.
                            </motion.p>

                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                <Link to={ctaTest.value.link} onClick={() => handleCTAClick(ctaTest.value.text, 'hero')} className="w-full sm:w-[240px]">
                                    <Suspense fallback={<div className="w-full h-14 bg-white/10 backdrop-blur rounded-lg animate-pulse" />}>
                                        <ShinyButton className="w-full h-14 text-sm font-black tracking-widest shadow-neon-cyan active:scale-95 transition-transform uppercase italic">
                                ...
                                <a href="https://github.com/suduli" target="_blank" rel="noopener noreferrer" className="w-full sm:w-[240px]">
                                    <motion.button
                                        whileHover={prefersReducedMotion ? undefined : { scale: 1.02 }}
                                        whileTap={prefersReducedMotion ? undefined : { scale: 0.98 }}
                                        className="w-full h-14 flex items-center justify-center bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-cyber-blue/30 text-dark-900 dark:text-cyber-blue font-black text-sm uppercase tracking-widest rounded-lg hover:border-cyber-blue transition-all duration-300 shadow-sm"
                                    >
                                        GitHub Repository
                                    </motion.button>
                                </a>
                    ...
                    {/* Tech Marquee */}
                    <section className="py-12 relative z-10 overflow-hidden border-y border-gray-200 dark:border-white/5 bg-white/50 dark:bg-dark-950/20 backdrop-blur-sm">
                        <Suspense fallback={null}>
                    ...
                    <section className="container mx-auto px-4 py-24 relative z-10">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                            {stats.map((stat, index) => (
                                <Suspense key={stat.label} fallback={<div className="h-[260px] w-full rounded-3xl bg-white/5 animate-pulse" />}>
                                    <CyberStatCard
                                        value={stat.value}
                                        label={stat.label}
                                        icon={stat.icon}
                    ...
                    <section className="container mx-auto px-4 py-32 relative z-10">
                        <div className="text-center mb-20">
                            <h2 className="text-5xl sm:text-7xl font-black mb-8 italic gradient-text tracking-tighter uppercase">
                                ENGINEERING GRADE<br />CAPABILITIES
                            </h2>
                            <p className="text-2xl font-black text-light-600 dark:text-gray-400 max-w-3xl mx-auto leading-tight italic">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                            {features.map((feature, index) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        "cyber-glass p-10 group cursor-pointer rounded-[3rem] border-2 transition-all duration-500",
                                    ...
                                    <div className={cn("cyber-glass p-8 sm:p-16 rounded-[3.5rem] border-0 w-full", glassSurface)}>
                                        ...
                                        <div className="bg-dark-950 rounded-[2.5rem] p-6 sm:p-10 border border-white/10 shadow-3xl relative overflow-hidden font-mono">
                                            <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/5">
                                                ...
                                                <div className="text-[10px] text-gray-500 uppercase tracking-widest flex items-center gap-4">
                    ...
                    <section className="container mx-auto px-4 py-32 relative z-10">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={cn(
                                "max-w-5xl mx-auto text-center cyber-glass p-20 rounded-[4rem] border-2 border-transparent hover:border-cyber-blue/30 transition-all duration-700 shadow-3xl",
                                isDark ? "bg-white/5" : "bg-white shadow-2xl",
                            )}
                        >
                            <h2 className="text-7xl sm:text-8xl font-black mb-10 text-dark-900 dark:text-white tracking-tighter uppercase italic leading-[0.8]">
